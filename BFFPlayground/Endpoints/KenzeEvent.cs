...
internal static class KenzeEvents
{
    ...
    public static async Task<IResult> NewEvent([FromBody] KenzeEvent newEvent, [FromServices] EventDbContext context)
    {
    ...
    public static async Task<IResult> DeleteEvent([FromRoute] int eventId, [FromServices] EventDbContext context)
    {
    ...
    public static async Task<IResult> WillAttend([FromRoute] int eventId, [FromServices] EventDbContext context)
    {
        return TypedResults.Ok();
    }
    
    public static async Task<IResult> WontAttend([FromRoute] int eventId, [FromServices] EventDbContext context)
    {
        return TypedResults.Ok();
    }
}
